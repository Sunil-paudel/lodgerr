...
const connect = async ()=>{
    ...
    if (__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connection.readyState === 2) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect(process.env.MONGO); // Added non-null assertion as we check MONGO above
...
async function POST(request) {
    try {
        ...
        console.log("Signup request received for:", {
            fullName,
            email
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__63dcaca0._.js.map