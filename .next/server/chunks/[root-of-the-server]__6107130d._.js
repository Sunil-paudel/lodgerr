    ...
    toJSON: {
        ...
        transform: function(doc, ret) {
            ...
            if (ret.bookedDateRanges) {
                ret.bookedDateRanges = ret.bookedDateRanges.map((range)=>({
...
async function POST(request) {
    try {
        ...
        const conflictingBookingInDB = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (property.bookedDateRanges) {
            const conflictingRange = property.bookedDateRanges.find((range)=>{
                const rangeStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(range.startDate));
                const rangeEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(range.endDate));
                return [
                    'pending_payment',
                    'pending_confirmation',
                    'confirmed_by_host'
                ].includes(range.status) && normalizedStartDate < rangeEnd && normalizedEndDate > rangeStart;
            });
            if (conflictingRange) {
                console.log("[API /bookings/initiate-payment POST] Conflict found with property.bookedDateRanges:", conflictingRange);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'These dates are no longer available (conflict in property data). Please choose different dates.'
                }, {
                    status: 409
                });
            }
        ...
        const updatedProperty = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(propertyId, {
            $push: {
        ...
        if (!updatedProperty) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Property update failed after booking creation. Booking cancelled.'
            }, {
                status: 500
            });
        } else {
            ...
            line_items: [
                {
                    price_data: {
                        ...
                        product_data: {
                            ...
                            images: updatedProperty.images && updatedProperty.images.length > 0 ? [
                                updatedProperty.images[0]
                            ] : undefined
                        },
        ...
        if (!stripeSession.id) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(newBooking._id);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(propertyId, {
                $pull: {
                    bookedDateRanges: {
                        bookingId: newBooking._id
                    }
        ...
        const hostUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(updatedProperty.hostId).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6107130d._.js.map