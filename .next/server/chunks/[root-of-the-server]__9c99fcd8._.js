...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/db.ts [app-route] (ecmascript)"); // Changed from connect to connectDB
...
const POST = async (request)=>{
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(); // Changed from connect() to connectDB()
        ...
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 5);
        ...
        if (errorMessage.startsWith("Database connection failed:") || errorMessage === "Server configuration error: MONGODB_URI is not defined.") {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Server error: Could not connect to the database. Please try again later.",
                error: errorMessage
            }, {
                status: 500
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9c99fcd8._.js.map