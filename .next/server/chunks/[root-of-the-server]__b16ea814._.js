...
"[project]/.next-internal/server/app/api/properties/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/properties/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/Booking.ts [app-route] (ecmascript)"); // Import Booking model
...
;
;
const propertyUpdateSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["object"])({
    title: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().min(5).max(100).optional(),
    description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().min(20).max(5000).optional(),
    type: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enum"])([
        "House",
        "Apartment",
        "Room",
        "Unique Stay"
    ]).optional(),
    location: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().min(3).max(100).optional(),
    address: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().min(5).max(200).optional(),
    price: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].number().positive().min(1).max(100000).optional(),
    pricePeriod: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enum"])([
        "nightly",
        "weekly",
        "monthly"
    ]).optional(),
    bedrooms: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].number().min(0).max(20).optional(),
    bathrooms: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].number().min(0).max(10).optional(),
    maxGuests: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].number().min(1).max(50).optional(),
    images: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["array"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["object"])({
        url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().url()
    })).min(1, "At least one image is required.").max(5, "Maximum 5 images allowed.").optional(),
    amenities: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["array"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])()).optional(),
    availableFrom: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].date().nullable().optional(),
    availableTo: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["coerce"].date().nullable().optional()
}).refine((data)=>{
    if (data.availableFrom && data.availableTo) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValid"])(data.availableFrom) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValid"])(data.availableTo)) return false;
...
async function GET(request, { params }) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const propertyDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).lean();
        if (!propertyDoc) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(propertyResponse, {
            status: 200
        });
    } catch (error) {
...
async function PATCH(request, { params }) {
    ...
    if (!session || !session.user || !session.user.id) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Unauthorized: You must be logged in to update a property.'
        }, {
            status: 401
        });
    }
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const propertyToUpdate = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!propertyToUpdate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Property not found.'
            }, {
        ...
        if (!isOwner && !isAdmin) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Forbidden: You are not authorized to update this property.'
            }, {
                status: 403
            });
        }
        ...
        for(const key in restOfData){
            if (restOfData[key] !== undefined) {
                updateOperation.$set[key] = restOfData[key];
            }
        }
        if (images !== undefined) {
        ...
        if (availableFrom !== undefined) {
            updateOperation.$set.availableFrom = availableFrom ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(availableFrom) : null;
        }
        if (availableTo !== undefined) {
            updateOperation.$set.availableTo = availableTo ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(availableTo) : null;
        }
        if (Object.keys(updateOperation.$set).length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'No valid fields provided for update (after processing).'
            }, {
                status: 400
            });
        }
        const updatedProperty = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, updateOperation, {
            new: true,
            runValidators: true
        });
        if (!updatedProperty) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Property found but update failed unexpectedly.'
            }, {
                status: 500
            });
        }
...
async function DELETE(request, { params }) {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const propertyToDelete = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!propertyToDelete) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Property not found.'
            }, {
        ...
        const hasActiveOrPendingBookingsInRanges = propertyToDelete.bookedDateRanges.some((range)=>nonDeletableStatuses.includes(range.status) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(new Date(range.endDate)) >= (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(new Date()) // Check if booking end date is today or in future
        );
        ...
        const activeBookingsInCollection = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            listingId: propertyToDelete._id,
            bookingStatus: {
                $in: nonDeletableStatuses
            },
            endDate: {
                $gte: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfDay$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["startOfDay"])(new Date())
            }
        });
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b16ea814._.js.map