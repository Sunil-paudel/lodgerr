...
async function POST(request) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const property = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(propertyId);
        if (!property) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const conflictingBooking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (property.pricePeriod === 'nightly') {
            ...
            numberOfUnits = Math.ceil((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(normalizedEndDate, normalizedStartDate) / 7);
        } else if (property.pricePeriod === 'monthly') {
            numberOfUnits = Math.ceil((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(normalizedEndDate, normalizedStartDate) / 30);
        }
        if (numberOfUnits <= 0 && !(property.pricePeriod === 'nightly' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(normalizedEndDate, normalizedStartDate) === 0)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (property.pricePeriod === 'nightly' && numberOfUnits === 0 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInCalendarDays$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInCalendarDays"])(normalizedEndDate, normalizedStartDate) === 0) {
            numberOfUnits = 1;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8b7a8f0._.js.map