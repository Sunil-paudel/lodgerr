...
"[project]/.next-internal/server/app/api/bookings/[bookingId]/manage/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/bookings/[bookingId]/manage/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"605e71c4b6c2ff0884ce117d2781007297255954dd":"PATCH"},"",""] */ __turbopack_context__.s({
    "PATCH": (()=>PATCH)
});
...
;
;
const manageBookingSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["object"])({
    status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enum"])([
        'confirmed_by_host',
        'rejected_by_host',
        'cancelled_by_admin'
    ])
...
async function PATCH(request, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const booking = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(bookingId);
        if (!booking) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const tempProperty = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Property$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(booking.listingId).lean();
        if (!tempProperty) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (newStatus === 'cancelled_by_admin') {
            ...
            if (![
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Cannot cancel booking as admin. Current status is '${booking.bookingStatus}'. Action applicable to 'confirmed_by_host' or 'pending_confirmation' bookings.`
                }, {
                    status: 409
                });
            }
            ...
            if (booking.paymentStatus === 'paid') {
                booking.paymentStatus = 'refunded'; // Conceptual refund
            }
            // Delete BookedDateRange as the booking is cancelled
            const deletedBookedDateRange = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$BookedDateRange$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            ...
            if (!isHost && !isAdmin) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Forbidden: You are not authorized to manage this booking as host.'
                }, {
                    status: 403
                });
            }
            if (booking.bookingStatus !== 'pending_confirmation') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: `Cannot update booking. Current status is '${booking.bookingStatus}', not 'pending_confirmation'.`
                }, {
                    status: 409
                });
            }
            ...
            if (newStatus === 'confirmed_by_host') {
                const updatedBookedDateRange = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$BookedDateRange$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                    bookingId: booking._id
                }, {
                    $set: {
                        status: newStatus
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(PATCH, "605e71c4b6c2ff0884ce117d2781007297255954dd", null);
}}),

};

//# sourceMappingURL=%5Broot-of-the-server%5D__df6382bc._.js.map